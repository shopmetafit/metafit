                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        ...
                        <div className="hidden md:flex flex-col gap-4">
                            ...
                            {selectedProduct?.videoUrl && (
                                <div
                                    className={`relative w-20 h-20 rounded-lg overflow-hidden cursor-pointer transition-all duration-300 group ${mainImage === "video"
                                            ? "ring-2 ring-black"
                            ...
                            {selectedProduct.images.map((image, index) => (
                                <img
                                    ...
                                    className={`w-20 h-20 object-cover rounded-lg cursor-pointer transition-all duration-300 ${mainImage === image.url
                                            ? "ring-2 ring-black"
                                            : "hover:ring-1 hover:ring-gray-400"
                                        }`}
                            ...
                            <div className="md:hidden flex overflow-x-auto gap-3 mt-4 scrollbar-hide">
                                {selectedProduct.images.map((image, index) => (
                                    <img
                                        ...
                                        src={image.url}
                                        alt={image.altText || `Thumbnail ${index}`}
                                        className={`w-20 h-20 object-cover rounded-lg cursor-pointer transition-all ${mainImage === image.url
                                                ? "ring-2 ring-black"
                                                : "hover:ring-1 hover:ring-gray-400"
                                            }`}
                                        onClick={() => setMainImage(image.url)}
                        ...
                        <div className="md:w-1/2">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                        {selectedProduct.variants.map((variant, idx) => (
                                            <button
                                                ...
                                                className={`p-4 border-2 rounded-lg transition-all text-center ${selectedVariant?._id === variant._id ||
                                    ...
                                    {selectedVariant && (
                                        <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                                            <p className="text-sm text-blue-800">
                                                <strong>Selected:</strong> {selectedVariant.label} - ₹{selectedVariant.discountPrice || selectedVariant.price}
                                            </p>
                                        </div>
                                    )}
                                </div>
                            ...
                            <button
                                ...
                                className={`bg-teal-600 text-white px-6 py-3 rounded-lg w-full transition-all ${isButtonDisabled
