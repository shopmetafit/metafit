        ...
        products.map((product) => (
          ...
          >
            <Link to={`/product/${product._id}`} className="flex flex-col flex-1" onClick={() => onProductClick && onProductClick()}>
              {/* Image Section */}
              <div className="bg-[#fcf8f2] rounded-[20px] aspect-[4/3] w-full relative overflow-hidden flex items-center justify-center p-6 group-hover:bg-[#f6f0e6] transition-colors">
                ...
                <button
                  ...
                  className="absolute top-3 right-3 bg-white w-8 h-8 rounded-full flex items-center justify-center shadow-sm z-10 text-gray-500 hover:text-red-500 transition-colors"
                >
