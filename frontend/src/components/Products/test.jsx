...
const FilterSidebar = () => {
  ...
  return (
    <div className="p-4">
      ...
      {/*  Routines filter */}
      <div className="mb-6">
        <label className="block text-gray-600 font-medium mb-2">Routine</label>
          ...
          return (
            <div key={dietaryPreference} className="flex items-center mb-1">
              <input
                ...
                onChange={handleFilterChange}
                // checked={filters.dietaryPreference == dietaryPreference}
                className="mr-2 h-4 w-4 text-blue-500 focus:ring-blue-400 border-gray-300"
              />
      ...
      {/* Benefit filter */}
      <div className="mb-6">
        <label className="block text-gray-600 font-medium mb-2">Benefit</label>
