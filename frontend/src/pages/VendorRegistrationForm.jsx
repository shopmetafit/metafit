                        ...
                        <div className="flex justify-between items-center">
                            {[1, 2, 3, 4, 5].map((step) => (
                                <div key={step} className="flex flex-col items-center flex-1">
                                    ...
                                    {step < 5 && (
                                        <div
                                            className={`flex-1 h-1 mx-2 mt-4mb-2  ${
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows="4"
                                        autoComplete="off"
                                        className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 transition ${errors.businessDescription
                        ...
                        <div className="flex justify-between mt-8 pt-6 border-t">
                            ...
                            {currentStep < 5 ? (
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className={`px-6 py-2 rounded-lg font-medium transition flex items-center space-x-2 ${loading
