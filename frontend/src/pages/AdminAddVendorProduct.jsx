...
const AdminAddVendorProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_URL}/api/products/admin/add-for-vendor/${vendorId}`,
        productData,
        {
      ...
      toast.success("Product created successfully for vendor ✅");
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <h2 className="text-2xl font-bold mb-2">Add Product for Vendor</h2>
      <p className="text-gray-600 mb-6">Vendor ID: {vendorId}</p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end">
          ...
          >
            {uploading ? "Creating..." : "Save Product"}
          </button>
        </div>
      </form>
    </div>
...
export default AdminAddVendorProduct;
